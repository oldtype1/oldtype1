...
<script type="text/javascript">
	$(document).ready(function() {
		$("#inputcheckPassword3").keyup(function() {
			if($("#inputcheckPassword3").val()!=$("#inputPassword3").val()){
				$("#passCheckView").html("비밀번호가 다릅니다!").css("background","#ffe4e1");
				$("#regOk").hide();
				
			}else if ($("#inputcheckPassword3").val()==$("#inputPassword3").val()){
				$("#passCheckView").html("비밀번호같아용~~").css("background","#f0ffff");
				$("#regOk").show();
			}
		});
		...
		<div class="row">
			<div class="col-md-12">
				<form:form class="form-horizontal" role="form"
					action="${initParam.root}member_register.do" enctype="multipart/form-data"
					method="post" commandName="memberVO" id="regForm">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<form:input type="password" class="form-control" id="inputPassword3"
								placeholder="Password" name="memberPass" path="memberPass"/>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="password" class="form-control"
								id="inputcheckPassword3" placeholder="password again" required="required"/>
						</div>
