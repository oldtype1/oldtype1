...
public interface InnDAO {
	...
	//이거 초기조건 필터 / 인원수 / 이름
	public abstract List<InnVO> selectInnByWordAndAcceptNoWithPrice(HashMap<String, Object> param);
	public abstract int getTotalSearchingCountWithNoDateAndPriceAndAmenity(HashMap<String, Object> param);
	
	
	//이거 초기조건 필터 / 인원수 / 이름 / 날짜
	public abstract List<InnVO> selectInnByWordAndAcceptNoAndDateWithPrice(HashMap<String, Object> param);
	public abstract int getTotalSearchingCountWithDateAndPriceAndAmenity(HashMap<String, Object> param);
