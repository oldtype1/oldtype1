...
public class InnVO {
	...
	/*
	 * private List<AvailableDateVO> availableDateVO; private AmenityVO
	 * amenityVO; private List<InnPicCompVO> innPicCompVO; private
	...
	public InnVO(int innNo, String innName, String innCity, String innArea,
			...
			String memberId, ArrayList<String> amenity, InnPicCompVO innMainPic) {
		super();
		this.innNo = innNo;
	...
	public String toString() {
		return "InnVO [innNo=" + innNo + ", innName=" + innName + ", innCity="
				...
				+ ", memberId=" + memberId + ", amenity=" + amenity
