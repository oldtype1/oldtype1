        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <form class="form-horizontal" role="form">
              ...
              <center>
                <a class="btn btn-danger btn-lg col-sm-8 input-lg">예약하기</a>
              </center>
            </form>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <form class="form-horizontal text-center" role="form">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control input-lg" id="inputEmail3" value="${requestScope.innVO.innAddress}" readonly="readonly">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" readonly="readonly">${requestScope.innVO.innInfo}</textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-5 text-left">
                  ...
                  <input class="form-control input-lg " type="text" value="${requestScope.innVO.innName}" readonly="readonly">
                </div>
              </div>
            </form>
          </div>
